...
namespace CSparse.Complex
{
    ...
    public class Triangular
    {
        ...
        public static bool SolveL(SparseMatrix L, Complex[] x)
        {
        ...
        /// <param name="x">size n, right hand side on input, solution on output</param>
        /// <returns>true if successful, false on error</returns>
        public static bool SolveU(SparseMatrix U, Complex[] x)
        {
            if (x == null) return false; // check inputs
        ...
        public static int SolveSp(SparseMatrix G, SparseMatrix B, int k, int[] xi, Complex[] x, int[] pinv, bool lo)
        {
