...
namespace CSparse.Double
{
    ...
    public class TripletMatrix
    {
        ...
        public TripletMatrix(int m, int n, int nzmax, bool values = true)
        {
        ...
        public bool Entry(int ii, int jj, double xx)
        {
        ...
        /// <param name="jj">column index of new entry</param>
        /// <param name="xx">numerical value of new entry</param>        
        public double this[int ii, int jj]
        {
            set { this.Entry(ii, jj, value); }
        }
